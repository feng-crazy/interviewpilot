...
InterviewPilot 是一款企业级 AI 面试智能体系统，适用于初面场景。系统基于面试官配置的岗位 JD、公司信息、面试流程要求等信息，通过 AI 自动对面试者进行面试提问，最终生成人才画像、分析报告和录用指南。
...
| | 公司信息输入 | P0 | 必填，文本输入框 |
| | 面试官信息输入 | P0 | 必填，姓名、职位等 |
| | 流程要求输入 | P0 | 必填，面试轮次、考察重点 |
...
CREATE TABLE interviews (
    ...
    interviewer_info TEXT NOT NULL,            -- 面试官信息
    process_requirement TEXT NOT NULL,         -- 流程要求
...
class ConfigRequest:
    ...
    interviewer_info: str         # 面试官信息
    process_requirement: str      # 流程要求
